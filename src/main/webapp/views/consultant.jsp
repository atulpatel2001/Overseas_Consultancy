					...
					<div class="col-md-5 offset-md-4">
						<div class="card mt-3">
							...
							<div class="card-body"  style="background-color: #E0E0E0;">
								<form id="consultant-reg-form">
									<div class="form-group">
										<label for="name">Consultant Name</label>
										<input name="name" type="text" class="form-control" id="name"
											aria-describedby="emailHelp" placeholder="Enter Consultant Name" required />
									</div>

									<div class="form-group">
										<label for="emailId">Consultant Email</label>
									...
									<div class="form-group">
										<label for="specification">Consultant specification</label>
